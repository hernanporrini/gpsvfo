...
#define F1 4000000 // zwora Z1
#define F2 15000000 // zwora Z2
#define F3 20000000  // zwora Z1&Z2
...
void setup()
{
  ...
  if (!digitalRead(Z1)) Freq = 1000000;
  if (!digitalRead(Z2)) Freq = 20000000;
  if ((!digitalRead(Z1))&& (!digitalRead(Z2))) Freq = 4000000;
